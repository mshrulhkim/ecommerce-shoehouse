...
<nav class="navbar fixed-top navbar-expand-sm navbar-black" style="background-color:rgba(255,255,255)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Oswald'">Shoehouse</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#vans" class="dropdown-item">Vans</a>
                                   <a href="products.php#converse" class="dropdown-item">Converse</a>
                                   <a href="products.php#adidas" class="dropdown-item">Adidas</a>
                                   <a href="products.php#nike" class="dropdown-item">Nike</a>
                               </div>
