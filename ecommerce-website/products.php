...
<div class="container" style="margin-top:65px">
        ...
        <div class="jumbotron text-center">
            <h1>Welcome to Shoehouse!</h1>
            <p>Find you favorite products</p>
        </div>
        <!--jumbutron ends-->
        <!--breadcrumb start-->
    ...
    <hr/>
    <!--menu list-->
    <div class="row text-center" id="vans">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/vans1.jpeg" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Vans Slipon x Kakao Friends</h6>
                    <h6>Rp. 650.000</h6>    
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/vans2.jpeg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Vans Slipon Pro BW</h6>
                    <h6>Rp. 600.000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/vans3.jpeg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Vans Slipon Black White</h6>
                    <h6>Rp. 750.000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/vans4.jpeg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Vans Slipon Sidewall</h6>
                    <h6>Rp. 750.000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
    ...
    <div class="row text-center" id="converse">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/converse1.jpeg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>Converse 70s High</h6>
                    <h6>Rp. 950.000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/converse2.jpeg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Converse All Star Lift</h6>
                    <h6>Rp. 500.000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/converse3.jpeg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Converse Pro Blaze</h6>
                        <h6>Rp. 600.000</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/converse4.jpeg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Converse 70s Low</h6>
                        <h6>Rp. 875.000</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="row text-center" id="adidas" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/adidas1.jpeg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Adidas LA Trainer WBR</h6>
                            <h6>Rp. 1.450.000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/adidas2.jpeg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Adidas Handball Spezial BO</h6>
                            <h6>Rp. 1.600.000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/adidas3.jpeg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Adidas Padiham Royal Blue</h6>
                            <h6>Rp. 1.500.000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/adidas4.jpeg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h6>Adidas ZX420 Halo Green</h6>
                        <h6>Rp. 1.400.000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="row text-center" id="nike">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="images/nike1.jpeg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Nike Dunk Atmos</h6>
                                <h6>Rp. 550.000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/nike2.jpeg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Nike Dunk Denim</h6>
                                <h6>Rp. 650.000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/nike3.jpeg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Nike Dunk Kawa Kawa</h6>
                                <h6>Rp. 600.000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/nike4.jpeg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Nike Panda Frgmnt</h6>
                                <h6>Rp. 700.000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
